<template>
    <header class="sticky top-0 bg-weather-primary shadow-lg z-10">
        <nav class="container flex flext-col sm:flex-row items-center gap-4 text-white py-6">
             ...
             >
                <div class="text-black">
                    ...
                    <p>If you no longer wish to track a city, simply select the city within the home page. At the top of 
                        the page, there will be an option to delete the city.
                    </p>
                </div>
            </BaseModal>
        </nav>
